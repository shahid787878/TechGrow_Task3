  ...
  return (
    ...
    <div className="container-fluid " >
                  ...
                  <ul className="nav ">
                    ...
                    <li className="nav-item dropdown">
                      ...
                      <ul className="dropdown-menu">
                        ...
                        <li><a className="dropdown-item" href="/">404 or Page</a></li>
          ...
          <div className="section-1  w border borderd-3  justify-content-center mx-auto  w-100 ">
            ...
            <div id="demo78" className="carousel slide" data-bs-ride="carousel">
           ...
           <img style={{height:'100vh'} } className="w-100" src=" https://images.pexels.com/photos/1704488/pexels-photo-1704488.jpeg?auto=compress&cs=tinysrgb&w=600"alt="" />
              ...
              <button className="carousel-control-prev" type="button" data-bs-target="#demo78" data-bs-slide="prev">
              <span className="carousel-control-prev-icon p-2 bg-dark"></span>
              </button>
              <button className="carousel-control-next" type="button" data-bs-target="#demo78" data-bs-slide="next">
              <span className="carousel-control-next-icon p-2 bg-dark"></span>
              </button>
            </div>
                  <div className="section-1  w border borderd-3  justify-content-center mx-auto  w-100 ">
         
            <div id="demo781" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
            
                <div className="carousel-item active two " >
                <div className="container-fluid  d-flex justify-content-center align-items-center h-100 w-100   text-center">
           {/* <img style={{height:'100vh'} } className="w-100" src="https://images.pexels.com/photos/248241/pexels-photo-248241.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" /> */}
                  ...
                  <div className="col mb-4">
                      <div className="card ">
                       <img style={{height:'100vh', width:'100vh'}} alt="" src="https://images.pexels.com/photos/2179205/pexels-photo-2179205.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                    ...
                    <div className="col mb-4">
                       <div className="card">
                        <img  style={{height:'100vh', width:'100vh'}} alt="" src="https://images.pexels.com/photos/673021/pexels-photo-673021.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                     ...
                     <div className="col mb-4">
                       <div className="card">
                        <img  style={{height:'100vh', width:'100vh'}}alt="" src="https://images.pexels.com/photos/943241/pexels-photo-943241.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                     ...
                     <div className="col mb-4">
                       <div className="card">
                        <img style={{height:'100vh', width:'100vh'}} alt="" src="https://images.pexels.com/photos/1484771/pexels-photo-1484771.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                           <span className="price text-danger fw-bold">INR2500</span>
                           <del>$55.25</del>
                     ...
                     <div className="col mb-4">
                       <div className="card">
                        <img style={{height:'100vh', width:'100vh'}} alt="" src="https://images.pexels.com/photos/1854897/pexels-photo-1854897.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                           <span className="price text-danger fw-bold">INR2500</span>
                           <del>$55.25</del>
                     ...
                     <div className="col mb-4">
                       <div className="card">
                        <img  style={{height:'100vh', width:'100vh'}}alt="" src="https://images.pexels.com/photos/302355/pexels-photo-302355.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                           <span className="price text-danger fw-bold">INR2500</span>
                           <del>$55.25</del>
                     ...
                     <div className="col mb-4">
                        <div className="card">
                         <img style={{height:'100vh', width:'100vh'}} alt="" src="https://images.pexels.com/photos/610294/pexels-photo-610294.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                          <div className="card-body">
                            <h5 className="card-title">Photography</h5>
                            <span className="price text-danger fw-bold">INR2500</span>
                            <del>$55.25</del>
                      ...
                      <div className="col mb-4">
                        <div className="card">
                         <img style={{height:'100vh', width:'100vh'}} alt="" src="https://images.pexels.com/photos/1374510/pexels-photo-1374510.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                          <div className="card-body">
                            <h5 className="card-title">Photography</h5>
                            <span className="price text-danger fw-bold">INR2500</span>
                            <del>$55.25</del>
                      ...
                      <div className="col mb-4">
                        <div className="card">
                         <img style={{height:'100vh', width:'100vh'}} alt="" src="https://images.pexels.com/photos/1426044/pexels-photo-1426044.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                          <div className="card-body">
                            <h5 className="card-title">Photography</h5>
                            <span className="price text-danger fw-bold">INR2500</span>
                            <del>$55.25</del>
                      ...
                      <div className="col mb-4">
                        <div className="card">
                         <img style={{height:'100vh', width:'100vh'}} alt="" src="https://images.pexels.com/photos/3235566/pexels-photo-3235566.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                          <div className="card-body">
                            <h5 className="card-title">Photography</h5>
                            <span className="price text-danger fw-bold">INR2500</span>
                            <del>$55.25</del>
           ...
           <div className="row  text-center  " >
                  ...
                  <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5 row-fluid mx-auto;">
                    <div className="col mb-4">
                      <div className="card">
                       <img style={{height:'100vh', width:'100vh'}} alt="" src="https://images.pexels.com/photos/1396122/pexels-photo-1396122.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                        <div className="card-body">
                          <h5 className="card-title">Photography</h5>
                          <span className="price text-danger fw-bold">INR2500</span>
                          <del>$55.25</del>
                    ...
                    <div className="col mb-4">
                       <div className="card">
                        <img style={{height:'100vh', width:'100vh'}} alt="" src="https://images.pexels.com/photos/1029599/pexels-photo-1029599.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                           <span className="price text-danger fw-bold">INR4550</span>
                           <del>$155.25</del>
                     ...
                     <div className="col mb-4">
                       <div className="card">
                        <img style={{height:'100vh', width:'100vh'}} alt="" src="https://images.pexels.com/photos/280229/pexels-photo-280229.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                           <span className="price text-danger fw-bold">INR2500</span>
                           <del>$55.25</del>
                     ...
                     <div className="col mb-4">
                       <div className="card">
                        <img style={{height:'100vh', width:'100vh'}} alt="" src="https://images.pexels.com/photos/1370704/pexels-photo-1370704.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                           <span className="price text-danger fw-bold">INR2500</span>
                           <del>$55.25</del>
                     ...
                     <div className="col mb-4">
                       <div className="card">
                        <img style={{height:'100vh', width:'100vh'}} alt="" src="https://images.pexels.com/photos/1438832/pexels-photo-1438832.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                           <span className="price text-danger fw-bold">INR2500</span>
                           <del>$55.25</del>
                     ...
                     <div className="col mb-4">
                       <div className="card">
                        <img style={{height:'100vh', width:'100vh'}} alt="" src="https://images.pexels.com/photos/280222/pexels-photo-280222.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                           <span className="price text-danger fw-bold">INR2500</span>
                           <del>$55.25</del>
                     ...
                     <div className="col mb-4">
                        <div className="card">
                         <img alt="" style={{height:'100vh', width:'100vh'}} src="https://images.pexels.com/photos/206172/pexels-photo-206172.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                          <div className="card-body">
                            <h5 className="card-title">Photography</h5>
                            <span className="price text-danger fw-bold">INR2500</span>
                            <del>$55.25</del>
                      ...
                      <div className="col mb-4">
                        <div className="card">
                         <img alt="" style={{height:'100vh', width:'100vh'}} src="https://images.pexels.com/photos/731082/pexels-photo-731082.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                          <div className="card-body">
                            <h5 className="card-title">Photography</h5>
                            <span className="price text-danger fw-bold">INR2500</span>
                            <del>$55.25</del>
                      ...
                      <div className="col mb-4">
                        <div className="card">
                         <img alt="" style={{height:'100vh', width:'100vh'}} src="https://images.pexels.com/photos/221540/pexels-photo-221540.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                          <div className="card-body">
                            <h5 className="card-title">Photography</h5>
                            <span className="price text-danger fw-bold">INR2500</span>
                            <del>$55.25</del>
                      ...
                      <div className="col mb-4">
                        <div className="card">
                         <img alt="" style={{height:'100vh', width:'100vh'}} src="https://images.pexels.com/photos/208736/pexels-photo-208736.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                          <div className="card-body">
                            <h5 className="card-title">Photography</h5>
                            <span className="price text-danger fw-bold">INR2500</span>
                            <del>$55.25</del>
           ...
           <div className="row  text-center  " >
                  ...
                  <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5 row-fluid mx-auto;">
                    <div className="col mb-4">
                      <div className="card">
                       <img alt="" style={{height:'100vh', width:'100vh'}} src="https://images.pexels.com/photos/76964/fighter-jet-f-15-strike-eagle-fighter-aircraft-jet-fighter-76964.jpeg?auto=compress&cs=tinysrgb&w=800" height="200"/>
                        <div className="card-body">
                          <h5 className="card-title">Photography</h5>
                          <span className="price text-danger fw-bold">INR2500</span>
                          <del>$55.25</del>
                    ...
                    <div className="col mb-4">
                       <div className="card">
                        <img  alt="" style={{height:'100vh', width:'100vh'}} src="https://images.pexels.com/photos/206881/pexels-photo-206881.jpeg?auto=compress&cs=tinysrgb&w=800" height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                           <span className="price text-danger fw-bold">INR4550</span>
                           <del>$155.25</del>
                     ...
                     <div className="col mb-4">
                       <div className="card">
                        <img alt="" style={{height:'100vh', width:'100vh'}} src="https://images.pexels.com/photos/76959/supersonic-fighter-aircraft-jet-jet-fighter-76959.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                           <span className="price text-danger fw-bold">INR2500</span>
                           <del>$55.25</del>
                     ...
                     <div className="col mb-4">
                       <div className="card">
                        <img alt="" style={{height:'100vh', width:'100vh'}} src="https://images.pexels.com/photos/618789/pexels-photo-618789.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                           <span className="price text-danger fw-bold">INR2500</span>
                           <del>$55.25</del>
                     ...
                     <div className="col mb-4">
                       <div className="card">
                        <img alt="" style={{height:'100vh', width:'100vh'}} src="https://images.pexels.com/photos/29375289/pexels-photo-29375289/free-photo-of-classic-silver-jet-on-tarmac-at-sunset.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                           <span className="price text-danger fw-bold">INR2500</span>
                           <del>$55.25</del>
                     ...
                     <div className="col mb-4">
                       <div className="card">
                        <img alt="" style={{height:'100vh', width:'100vh'}} src="https://images.pexels.com/photos/3850909/pexels-photo-3850909.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                           <span className="price text-danger fw-bold">INR2500</span>
                           <del>$55.25</del>
                     ...
                     <div className="col mb-4">
                        <div className="card">
                         <img alt="" style={{height:'100vh', width:'100vh'}} src="https://images.pexels.com/photos/24342480/pexels-photo-24342480/free-photo-of-f-16-of-the-thundebirds-usaf-air-demo78nstration-squadron.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                          <div className="card-body">
                            <h5 className="card-title">Photography</h5>
                            <span className="price text-danger fw-bold">INR2500</span>
                            <del>$55.25</del>
                      ...
                      <div className="col mb-4">
                        <div className="card">
                         <img alt="" style={{height:'100vh', width:'100vh'}} src="https://images.pexels.com/photos/28904547/pexels-photo-28904547/free-photo-of-swiss-air-force-f-a-18-hornet-on-tarmac.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                          <div className="card-body">
                            <h5 className="card-title">Photography</h5>
                            <span className="price text-danger fw-bold">INR2500</span>
                            <del>$55.25</del>
                      ...
                      <div className="col mb-4">
                        <div className="card">
                         <img alt="" style={{height:'100vh', width:'100vh'}} src="https://images.pexels.com/photos/29066368/pexels-photo-29066368/free-photo-of-turkish-air-force-jet-display-at-teknofest-adana.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                          <div className="card-body">
                            <h5 className="card-title">Photography</h5>
                            <span className="price text-danger fw-bold">INR2500</span>
                            <del>$55.25</del>
                      ...
                      <div className="col mb-4">
                        <div className="card">
                         <img alt="" style={{height:'100vh', width:'100vh'}} src="https://images.pexels.com/photos/5213373/pexels-photo-5213373.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                          <div className="card-body">
                            <h5 className="card-title">Photography</h5>
                            <span className="price text-danger fw-bold">INR2500</span>
                            <del>$55.25</del>
              ...
              <button className="carousel-control-prev" type="button" data-bs-target="#demo781" data-bs-slide="prev">
              <span className="carousel-control-prev-icon p-2 bg-dark"></span>
              </button>
              <button className="carousel-control-next" type="button" data-bs-target="#demo781" data-bs-slide="next">
              <span className="carousel-control-next-icon p-2 bg-dark"></span>
              </button>
            </div>
    </div>
            <div className="section-2 container-fluid   bg-success  "  >
        ...
        <div className="container-fluid    mx-auto">
          <div className="row  text-center  " >
                 ...
                 <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5 row-fluid mx-auto;">
                   <div className="col mb-4">
                     <div className="card">
                      <img alt="" src="https://images.pexels.com/photos/3802510/pexels-photo-3802510.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                       <div className="card-body">
                         <h5 className="card-title">Photography</h5>
                         <span className="price text-danger fw-bold">INR2500</span>
                         <del>$55.25</del>
                   ...
                   <div className="col mb-4">
                      <div className="card">
                       <img  alt="" src="https://images.pexels.com/photos/326259/pexels-photo-326259.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                        <div className="card-body">
                          <h5 className="card-title">Photography</h5>
                          <span className="price text-danger fw-bold">INR4550</span>
                          <del>$155.25</del>
                    ...
                    <div className="col mb-4">
                      <div className="card">
                       <img alt="" src="https://images.pexels.com/photos/14401634/pexels-photo-14401634.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                        <div className="card-body">
                          <h5 className="card-title">Photography</h5>
                          <span className="price text-danger fw-bold">INR2500</span>
                          <del>$55.25</del>
                    ...
                    <div className="col mb-4">
                      <div className="card">
                       <img alt="" src="https://images.pexels.com/photos/14401740/pexels-photo-14401740.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                        <div className="card-body">
                          <h5 className="card-title">Photography</h5>
                          <span className="price text-danger fw-bold">INR2500</span>
                          <del>$55.25</del>
                    ...
                    <div className="col mb-4">
                      <div className="card">
                       <img alt="" src="https://images.pexels.com/photos/638479/pexels-photo-638479.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                        <div className="card-body">
                          <h5 className="card-title">Photography</h5>
                          <span className="price text-danger fw-bold">INR2500</span>
                          <del>$55.25</del>
                    ...
                    <div className="col mb-4">
                      <div className="card">
                       <img alt="" src="https://images.pexels.com/photos/14401632/pexels-photo-14401632.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                        <div className="card-body">
                          <h5 className="card-title">Photography</h5>
                          <span className="price text-danger fw-bold">INR2500</span>
                          <del>$55.25</del>
                    ...
                    <div className="col mb-4">
                       <div className="card">
                        <img alt="" src="https://images.pexels.com/photos/27783477/pexels-photo-27783477/free-photo-of-riesgo.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                           <span className="price text-danger fw-bold">INR2500</span>
                           <del>$55.25</del>
                     ...
                     <div className="col mb-4">
                       <div className="card">
                        <img alt="" src="https://images.pexels.com/photos/14401641/pexels-photo-14401641.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                           <span className="price text-danger fw-bold">INR2500</span>
                           <del>$55.25</del>
                     ...
                     <div className="col mb-4">
                       <div className="card">
                        <img alt="" src="https://images.pexels.com/photos/27776503/pexels-photo-27776503/free-photo-of-porsche-gt3-rs.jpeg?auto=compress&cs=tinysrgb&w=600 " height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                           <span className="price text-danger fw-bold">INR2500</span>
                           <del>$55.25</del>
                     ...
                     <div className="col mb-4">
                       <div className="card">
                        <img alt="" src="https://images.pexels.com/photos/14401638/pexels-photo-14401638.jpeg?auto=compress&cs=tinysrgb&w=600" height="200"/>
                         <div className="card-body">
                           <h5 className="card-title">Photography</h5>
                           <span className="price text-danger fw-bold">INR2500</span>
                           <del>$55.25</del>
